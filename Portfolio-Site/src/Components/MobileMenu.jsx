...
export default function MobileMenu({ isOpen, setIsOpen, baseClasses }) {
  ...
  return (
    <>
        ...
        <div className="md:hidden  w-full flex flex-col items-center gap-5 p-4 shadow-lg">
            {/* Topbar mit Burger-Icon rechts */}
            <div className="flex justify-around" > 
                <div className="text-xl font-bold  white-500 ">
        ...
        { isOpen &&
        <div className="md:hidden text-white w-full flex flex-col items-center gap-5 py-6 shadow-lg">
            <NavLink to="/"         onClick={() => setIsOpen(false)} className={baseClassesLight}>Home</NavLink>
            ...
            <NavLink to="/contact"  onClick={() => setIsOpen(false)} className="bg-black text-white px-4 py-2 rounded-full">
                Kontakt
            </NavLink>
        </div>
        }
